...
private extension View {
    ...
    ///
    /// DragGesture is added as a simultaneousGesture, to not interfere with other gestures  may add.
    ///
    /// - Parameters:
    ...
    ///   - onEnded: The modifier will handle the View's offset onEnded. This escaping closure is for  convenience.
    ///
